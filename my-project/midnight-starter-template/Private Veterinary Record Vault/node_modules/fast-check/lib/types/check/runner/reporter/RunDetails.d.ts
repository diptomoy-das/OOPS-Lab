import type { VerbosityLevel } from 'fast-check/lib/types/check/runner/configuration/VerbosityLevel.js';
import type { ExecutionTree } from 'fast-check/lib/types/check/runner/reporter/ExecutionTree.js';
