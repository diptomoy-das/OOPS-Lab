...
import type { StringConstraints } from 'fast-check/lib/types/arbitrary/string.js';
import type { DepthSize, SizeForArbitrary } from 'fast-check/lib/types/arbitrary/_internals/helpers/MaxLengthFromMinLength.js';
/**
