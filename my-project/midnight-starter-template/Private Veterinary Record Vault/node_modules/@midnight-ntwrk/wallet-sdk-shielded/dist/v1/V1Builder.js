...
import { makeDefaultProvingService } from './Proving.js';
...
export class V1Builder {
    ...
    #buildContextFromBuildState(configuration) {
        ...
        const { syncCapability, syncService, transactingCapability, serializationCapability, provingService, coinSelection, coinsAndBalancesCapability, keysCapability, submissionService, transactionHistoryCapability, } = this.#buildState;
