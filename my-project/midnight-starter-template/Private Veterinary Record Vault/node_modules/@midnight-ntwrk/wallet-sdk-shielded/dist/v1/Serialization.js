...
export const makeDefaultV1SerializationCapability = () => {
    ...
    return {
        ...
        deserialize: (aux, serialized) => {
            return pipe(serialized, Schema.decodeUnknownEither(Schema.parseJson(SnapshotSchema)), Either.mapLeft((err) => WalletError.other(err)), Either.flatMap((snapshot) => CoreWallet.restoreWithCoinHashes(snapshot.publicKeys, snapshot.state, snapshot.txHistory, snapshot.coinHashes, {
