...
import { CompactType } from '@midnight-ntwrk/compact-runtime/dist/compact-types.js';
/**
 ...
 */
export declare const contractDependencies: (contractReferenceLocations: ContractReferenceLocations, state: ocrt.StateValue) => ocrt.ContractAddress[];
