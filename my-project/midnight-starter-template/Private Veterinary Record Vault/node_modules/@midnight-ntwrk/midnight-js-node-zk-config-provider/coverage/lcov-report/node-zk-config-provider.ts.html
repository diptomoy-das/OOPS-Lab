...
<head>
    <title>Code coverage report for node-zk-config-provider.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> node-zk-config-provider.ts</h1>
        <div class='clearfix'>
